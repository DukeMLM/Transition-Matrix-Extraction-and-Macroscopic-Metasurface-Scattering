...
CLI:
    python -m tmatrix.retrieval.gate_study --freqs 32,48
    python -m tmatrix.retrieval.gate_study --freqs 32,48 --quick  # smoke run
    python -m tmatrix.retrieval.gate_study --freqs all --trials 20 --no-figs
...
def write_markdown(fm, store, args, path):
    ...
    A("")
    A("Generated by `tmatrix.retrieval.gate_study` (synthetic only -- no CST, "
