...
# Hard-coded dependency chain of the base script (par. 7): used only by
# --build, never by --dry-run.
AUTO_CST = Path("D:/Claude/auto_cst")
CST_PYTHON_LIB = r"E:\cst\AMD64\python_cst_libraries"
CMA_INFINITE = Path("D:/Claude/cma_infinite")   # template provenance (clone)
