...
REF_NPZ = HERE.parent / "aggregation" / "results" / "periodic_results.npz"
RUN_V3 = HERE.parent / "aggregation" / "cst_direct" / "run_v3"
RUN_EMPTY = HERE.parent / "aggregation" / "cst_direct" / "run_empty"
...
def import_cst_results(extra_paths=()):
    ...
    for p in (CST_PYTHON_LIB, *map(str, extra_paths)):
