...
# --------------------------------------------------------------- gufunc patch
# Windows / numpy>=2: the compiled gufuncs declare integer inputs as C long
# (int32) while numpy 2.x defaults to int64.  Same casting-only patch as
# aggregation/treams_reference.py and retrieval/treams_oblique_validate.py,
# made idempotent so importing several of them cannot double-wrap.

_PATCH_FLAG = "_fastfull_cast_wrapped"
