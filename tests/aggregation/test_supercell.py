...
from tmatrix.aggregation.vswf import (ModeBasis, RegularProjector, far_field_amplitude,
                  plane_wave_coeffs)
...
from tmatrix.paths import BENCHMARK_2X2

H5_A = str(BENCHMARK_2X2 / "saw_gold_wl13p10um_10to34THz.tmat.h5")
H5_B = str(BENCHMARK_2X2 / "saw_gold_wl17p30um_10to34THz.tmat.h5")
PITCH = 8.0
R0 = 3.0
