...
import vswf
from vswf import ModeBasis, RegularProjector
from translate import make_quad, lattice_sum_C
from mirror import mirror_parity_signs, image_lattice_sum, \
...
def test_energy_bounds_real_T():
    ...
    data = TMatrixData(os.path.join(
        here, "..", "test", "single", "saw_gold_wl15p0025um.tmat.h5"))
    modes = data.modes
    quad = make_quad(16, 32)
    s = mirror_parity_signs(modes)
    h = 0.35
